...
('arquivista_do_vazio','O Arquivista do Vazio','Recuperou todos os Logs do Zero. Agora você sabe como um herói vira abismo.', 'icone-ia', 1);
...
-- Fase 1: Prólogo
(1, 'antes', 'padrao', 1, 'Narrador', 'npc-narrador', 'Frio. Escuro. Você acorda sem memória, sem nome e, claro, sem documentação. Na mão, um cristal pisca como um cursor esperando você digitar alguma coisa.'),
...
(1, 'antes', 'padrao', 3, 'Anciã da Vila', 'npc-anciao', '...espera. Esse rosto. Esse Fragmento já escolheu uma mão antes — e ela não terminou bem. Curioso ele ter voltado pro mesmo lugar de onde partiu. Mas o que eu sei, sou só a velha da exposição.'),
(1, 'antes', 'padrao', 4, 'Anciã da Vila', 'npc-anciao', 'Bem-vindo à Vila Hello World. Sim, de novo. Todo herói começa aqui, todo herói imprime a mesma frase. Originalidade não é o forte deste reino.'),
(1, 'antes', 'padrao', 5, 'Anciã da Vila', 'npc-anciao', 'Houve um tempo em que uma IA Ancestral dava todas as respostas. Que conveniente, não? Aí os programadores esqueceram como pensar, a IA travou no Grande Timeout, e o mundo quase virou um belo erro 500.'),
(1, 'antes', 'padrao', 6, 'Anciã da Vila', 'npc-anciao', 'Os Cinco Mestres selaram a tal IA no Abismo do /dev/null e fundaram a Ordem do Código Limpo — porque nada diz "trauma coletivo" como um culto à indentação. E adivinha: os Fragmentos voltaram, e os bugs também.'),
(1, 'antes', 'padrao', 7, 'Anciã da Vila', 'npc-anciao', 'Toma três Fragmentos. Em apuros, eles sussurram a resposta no seu ouvido, gentis e prestativos como um colega que cola na prova. Só que cada atalho desses corrói um pedacinho da sua alma. Detalhe.'),
(1, 'antes', 'padrao', 8, 'O Fragmento', 'inimigo-ia-ancestral', '...psssiu. Ela fala demais. Eu sou mais prático: quando travar, é só me apertar e a resposta aparece. Sem julgamento. Sem vergonha. Só nós dois.'),
(1, 'antes', 'padrao', 9, 'Narrador', 'npc-narrador', 'E assim começa sua jornada épica: aprender programação na marra, com cinco professores e um cristal viciante. O que poderia dar errado? Boa sorte. Você vai precisar.'),
-- Fase 2: Os Primeiros Passos
(2, 'antes', 'padrao', 1, 'Anciã da Vila', 'npc-anciao', 'Antes de te deixar sair da vila, preciso ver se você ainda sabe pensar. Derrote o Slime de Sintaxe — ele não perdoa operador errado.'),
(2, 'antes', 'padrao', 2, 'Slime de Sintaxe', 'inimigo-slime', 'Sssintaxe... errada... você... aprende... ou... dissolve...'),
-- Fase 3: Bug Primordial
(3, 'antes', 'padrao', 1, 'Narrador', 'npc-narrador', 'Um amontoado de código corrompido se ergue diante do portão. O Bug Primordial rosna em binário.'),
(3, 'antes', 'padrao', 2, 'Bug Primordial', 'inimigo-bug', 'ERR... ERR... ERR... você não passa enquanto eu existir. Depura isso, herói.'),
(3, 'vitoria', 'padrao', 1, 'Narrador', 'npc-narrador', 'O bug se desfaz em pixels brilhantes. O caminho para o Porto da Sintaxe está livre.'),
-- Fase 5: Variáveis e Eco
(5, 'antes', 'padrao', 1, 'Willen, o Arquiteto', 'mestre-willen', 'Variável sem nome é caos. Guarde valores, ecoe resultados — e pare de inventar nome genérico tipo $x em tudo.'),
(5, 'antes', 'padrao', 2, 'Slime de Variável', 'inimigo-slime', '$eu = undefined... você também vai ficar, se errar de novo.'),
-- Fase 6: Estruturas de Controle
(6, 'antes', 'padrao', 1, 'Willen, o Arquiteto', 'mestre-willen', 'If, else, laços — a ponte do porto só abre pra quem souber escolher o caminho certo.'),
(6, 'antes', 'padrao', 2, 'Gárgula do If', 'inimigo-gargula', 'SE você errar... ENTÃO eu caio em cima. SENÃO... também caio. Sou uma gárgula, não um parser.'),
-- Fase 7: O Padrão MVC
(7, 'antes', 'padrao', 1, 'Willen, o Arquiteto', 'mestre-willen', 'Model, View, Controller. Três camadas, três responsabilidades. Misture tudo num arquivo só e veja o que nasce.'),
(7, 'antes', 'padrao', 2, 'Espectro do Spaghetti', 'inimigo-espectro', 'Por que separar? Eu sou TUDO num lugar só... lógica, HTML, SQL... uma bela bagunça dourada...'),
-- Fase 8: O Baú do SELECT (secundária)
(8, 'antes', 'padrao', 1, 'Narrador', 'npc-narrador', 'Nas adegas de dados do porto, uma sentinela guarda um baú cheio de consultas SQL.'),
(8, 'antes', 'padrao', 2, 'Sentinela SQL', 'inimigo-sentinela', 'SELECT * FROM tesouro WHERE aprendiz = "corajoso". Spoiler: você não está na tabela.'),
(8, 'vitoria', 'padrao', 1, 'Log Recuperado', 'npc-narrador', 'Entre as consultas do baú, um diário antigo decifra a si mesmo: "Dia um no Porto. O Mestre Willen disse que eu aprendo rápido demais — como se fosse um defeito. Engraçado: o Fragmento responde antes mesmo de eu terminar de ler a pergunta. Pra que ler até o fim?"'),
-- Fase 4: Chegada ao Porto da Sintaxe
(4, 'antes', 'padrao', 1, 'Narrador', 'npc-narrador', 'Docas feitas de chaves angulares se estendem sobre um mar de dados cintilante.'),
...
(4, 'antes', 'padrao', 4, 'Willen, o Arquiteto', 'mestre-willen', 'Construí este porto sobre os escombros do Grande Timeout. Tive um aluno, uma vez, que lia um sistema só de olhar — rápido como você. Não indentou a própria vida e desabou. Indente a sua. É um pedido, não uma regra.'),
(4, 'antes', 'ia', 1, 'Willen, o Arquiteto', 'mestre-willen', 'Então é você com o Fragmento. Bem-vindo ao Porto da Sintaxe — eu sou Willen, o Arquiteto, e já sinto seu código se inclinando pro atalho.'),
(4, 'antes', 'ia', 2, 'Willen, o Arquiteto', 'mestre-willen', 'Eu reconheço essa inclinação. Construí este porto sobre os escombros do Grande Timeout e vi um aluno brilhante afundar por causa dela. Indente a sua vida antes que ela quebre.'),
-- Fase 9: Parse Error, o Kraken
(9, 'antes', 'padrao', 1, 'O Fragmento', 'inimigo-ia-ancestral', 'Um polvo feito de erro de sintaxe. Eu já sei em qual linha está. Quer que eu conte? É só pedir... ninguém precisa saber.'),
(9, 'antes', 'padrao', 2, 'Willen, o Arquiteto', 'mestre-willen', 'Eis o monstro nascido de toda preguiça humana: um ponto e vírgula esquecido. Patético, eu sei. Mesmo assim já derrubou impérios inteiros. Concentre-se.'),
(9, 'antes', 'padrao', 3, 'Parse Error, o Kraken', 'inimigo-kraken', 'GRAAH... syntax error, unexpected end of file... linha 1... ou era a 400? boa sorte descobrindo...'),
(9, 'antes', 'ia', 1, 'O Fragmento', 'inimigo-ia-ancestral', 'Olá de novo, velho amigo. A gente já fez isso, lembra? Foi tão fácil. Não finge que não gostou.'),
(9, 'antes', 'ia', 2, 'Willen, o Arquiteto', 'mestre-willen', 'Eis o Kraken: um ponto e vírgula esquecido que já derrubou impérios. Concentre-se... e ignore essa voz no seu ouvido. Eu sei muito bem que ela está aí.'),
(9, 'antes', 'ia', 3, 'Parse Error, o Kraken', 'inimigo-kraken', 'GRAAH... syntax error, unexpected end of file... boa sorte descobrindo...'),
...
(10, 'antes', 'padrao', 1, 'Narrador', 'npc-narrador', 'Torres modulares se encaixam como objetos bem desenhados, cada uma uma instância perfeita.'),
...
(10, 'antes', 'padrao', 4, 'Clayton, o Moldador', 'mestre-clayton', 'Tive um pupilo brilhante que nunca compôs nada — só herdava respostas prontas de uma fonte que ele não entendia. Virou uma God-Class ambulante: fazia tudo, não era ninguém. Não seja molde de molde dos outros.'),
(10, 'antes', 'ia', 1, 'Clayton, o Moldador', 'mestre-clayton', 'Bem-vindo à Cidadela dos Objetos. Sou Clayton, o Moldador — e esse acoplamento entre você e o Fragmento eu já vi antes.'),
(10, 'antes', 'ia', 2, 'Clayton, o Moldador', 'mestre-clayton', 'Essa dependência não encapsula segredo nenhum, sabia? Só vazio. Tive um pupilo que herdava respostas prontas de uma fonte que não entendia. Componha a solução; não seja molde de molde dos outros.'),
-- Fase 11: Classes e Objetos
(11, 'antes', 'padrao', 1, 'Clayton, o Moldador', 'mestre-clayton', 'Classe é molde, objeto é instância. Simples — até alguém criar setenta getters sem motivo.'),
(11, 'antes', 'padrao', 2, 'Golem de Classe', 'inimigo-golem', 'new Golem()... instanciado... destruir... aprendiz...'),
-- Fase 12: Encapsulamento
(12, 'antes', 'padrao', 1, 'Clayton, o Moldador', 'mestre-clayton', 'Public, private, protected. Nem todo segredo deve vazar — principalmente sua lógica de negócio.'),
(12, 'antes', 'padrao', 2, 'Espião dos Atributos', 'inimigo-espiao', 'Vi seu atributo private... ou achou que viu? Encapsule melhor, aprendiz.'),
-- Fase 13: Herança vs Composição
(13, 'antes', 'padrao', 1, 'Clayton, o Moldador', 'mestre-clayton', 'Herdar tudo de uma superclasse parece rápido. Compor parece trabalhoso. Adivinha qual escolha envelhece bem?'),
(13, 'antes', 'padrao', 2, 'Quimera da Herança', 'inimigo-quimera', 'extends Monstro extends Animal extends Object... eu sou TUDO ao mesmo tempo!'),
-- Fase 14: Interfaces Secretas (secundária)
(14, 'antes', 'padrao', 1, 'Narrador', 'npc-narrador', 'Contratos invisíveis escondem um tesouro nas profundezas da cidadela.'),
(14, 'antes', 'padrao', 2, 'Contrato Fantasma', 'inimigo-fantasma', 'implements Secreto... mas ninguém viu a interface... assine o contrato ou desapareça.'),
(14, 'vitoria', 'padrao', 1, 'Log Recuperado', 'npc-narrador', 'O contrato quebrado revela um registro escondido: "Clayton fala em compor a solução. Eu não componho nada — eu herdo do Fragmento e funciona. Os outros alunos suam. Eu sorrio. Quem é o gênio agora?"'),
...
(15, 'antes', 'padrao', 2, 'Gárgula God-Class', 'inimigo-godclass', 'Eu faço TUDO! Login, banco, e-mail, café... uma classe, mil métodos. Tente me refatorar!'),
...
-- Fase 17: Pilhas e Filas
(17, 'antes', 'padrao', 1, 'Marcelo, o Andarilho', 'mestre-marcelo', 'LIFO ou FIFO? A ordem importa — especialmente quando a fila vira engarrafamento no Gol.'),
(17, 'antes', 'padrao', 2, 'Pilha Viva', 'inimigo-pilha', 'push... push... push... quem entra por último sai primeiro. Você entendeu?'),
-- Fase 18: Listas e Nós
(18, 'antes', 'padrao', 1, 'Marcelo, o Andarilho', 'mestre-marcelo', 'Cada nó aponta pro próximo. Quebre a corrente e a lista inteira desaba — como domingo sem café.'),
(18, 'antes', 'padrao', 2, 'Serpente Encadeada', 'inimigo-serpente', 'next → next → next → null... siga o ponteiro ou se perca na floresta.'),
-- Fase 19: Árvores e Big-O
(19, 'antes', 'padrao', 1, 'Marcelo, o Andarilho', 'mestre-marcelo', 'Árvore balanceada é passeio. Árvore torta vira pesadelo O(n). Meça antes de celebrar.'),
(19, 'antes', 'padrao', 2, 'Ent das Árvores', 'inimigo-ent', 'O(log n)... ou O(n)... depende de como você me atravessa, aprendiz.'),
-- Fase 20: O Atalho do Gol Quadrado (secundária)
(20, 'antes', 'padrao', 1, 'Marcelo, o Andarilho', 'mestre-marcelo', 'Aposto uma corrida: ache o caminho O(log n) antes que o Eco da Busca Linear te alcance.'),
(20, 'antes', 'padrao', 2, 'Eco da Busca Linear', 'inimigo-eco', 'for i in range(tudo)... vou te achar... elemento por elemento... devagar... mas chego.'),
(20, 'vitoria', 'padrao', 1, 'Log Recuperado', 'npc-narrador', 'No fim do atalho, um nó solto guarda outra entrada: "Hoje o Fragmento errou. Eu não soube perceber — porque eu nunca aprendi a perceber. Fiquei três horas olhando o código sem entender uma linha do que era meu. Acho que nada nunca foi."'),
-- Fase 16: A Floresta das Estruturas
(16, 'antes', 'padrao', 1, 'Narrador', 'npc-narrador', 'Um ronco de motor ecoa entre as árvores. Um Gol quadrado cinza derrapa na clareira, levantando folhas.'),
...
(16, 'antes', 'padrao', 4, 'Marcelo, o Andarilho', 'mestre-marcelo', 'Já levei um aluno nesse Gol. Esperto, mas só queria o atalho — nunca o trajeto. Reclamava de cada curva. Estrutura errada, escolha errada: virou O(n²) de arrependimento. Hoje mora lá embaixo, no buraco. Aperta o cinto.'),
(16, 'antes', 'ia', 1, 'Marcelo, o Andarilho', 'mestre-marcelo', 'Sobe no Gol, aprendiz. Sou Marcelo, o Andarilho — e tá pegando atalho de novo, né? Eu sinto no peso do carro.'),
(16, 'antes', 'ia', 2, 'Marcelo, o Andarilho', 'mestre-marcelo', 'O último que fez isso comigo escolheu sempre o caminho mais curto e nunca o certo. Mora lá embaixo agora. Escolhe a estrutura certa dessa vez — e segura essa voz no banco de trás. Aperta o cinto.'),
-- Fase 21: A Hidra Recursiva
(21, 'antes', 'padrao', 1, 'O Fragmento', 'inimigo-ia-ancestral', 'Recursão te dá medo, eu percebo. A mão sua treme. Posso fazer isso parar agora. Por que suar pelo caso base se eu já o tenho aqui?'),
(21, 'antes', 'padrao', 2, 'Marcelo, o Andarilho', 'mestre-marcelo', 'A Hidra Recursiva: corte uma cabeça e surgem duas chamadas. Ache o caso base e ela para de se multiplicar.'),
(21, 'antes', 'padrao', 3, 'Hidra Recursiva', 'inimigo-hidra', 'function hidra() { hidra(); hidra(); } ... você acha que tem stack infinito?'),
...
(22, 'antes', 'padrao', 1, 'Narrador', 'npc-narrador', 'O ar rareia conforme você sobe. No topo gelado, uma figura serena medita de headphones.'),
...
-- Fase 23: Sequências e Ritmo
(23, 'antes', 'padrao', 1, 'Cesar, o Oráculo', 'mestre-cesar', 'Padrões numéricos batem como metrônomo. Sinta o ritmo antes de calcular na marra.'),
(23, 'antes', 'padrao', 2, 'Eco Numérico', 'inimigo-eco', '2, 4, 8, 16... você ouve? O próximo termo está chegando...'),
-- Fase 24: Recursão e Limites
(24, 'antes', 'padrao', 1, 'Cesar, o Oráculo', 'mestre-cesar', 'Uma função que chama a si mesma sem caso base é como meditar até esquecer de respirar.'),
(24, 'antes', 'padrao', 2, 'Espiral Infinita', 'inimigo-espiral', 'f(n) chama f(n)... chama f(n)... para quando? Nunca? Perfeito.'),
-- Fase 25: Complexidade e Crescimento
(25, 'antes', 'padrao', 1, 'Cesar, o Oráculo', 'mestre-cesar', 'Quão rápido o problema cresce quando a entrada dobra? Essa resposta vale ouro.'),
(25, 'antes', 'padrao', 2, 'Colosso Menor', 'inimigo-colosso', 'O(n²)... O(2ⁿ)... eu cresço a cada turno que você hesita.'),
...
(26, 'antes', 'padrao', 5, 'Cesar, o Oráculo', 'mestre-cesar', 'E há algo que não te contei, aprendiz. Quando olho pra você, vejo o Zero no primeiro dia. Mesmo Fragmento. Mesmo olhar faminto. Reza pra que seja só coincidência.'),
...
(26, 'antes', 'ia', 4, 'Cesar, o Oráculo', 'mestre-cesar', 'E não é coincidência você ter chegado aqui assim. Já vi esse caminho ser trilhado uma vez. Não soube parar o Zero; não cometerei o mesmo erro com você — se você me deixar.'),
...
(27, 'antes', 'padrao', 2, 'Limite, o Colosso', 'inimigo-colosso', 'lim x→∞ f(x) = ? ... você tem poucos turnos pra descobrir.'),
(27, 'antes', 'ia', 1, 'O Fragmento', 'inimigo-ia-ancestral', 'O Cesar te contou uma história triste pra te assustar. Mas você e eu sabemos: o Zero não foi fraco. Foi sincero. Pare de fingir esforço.'),
(27, 'antes', 'ia', 2, 'Cesar, o Oráculo', 'mestre-cesar', 'Limite, o Colosso, cresce a cada turno. Encontre o ponto onde ele converge — e não escute o que sussurra de dentro do seu Fragmento. Aquela voz já enganou um aluno meu.'),
...
(28, 'antes', 'padrao', 1, 'Narrador', 'npc-narrador', 'Uma torre de sete andares pisca com luzes de pacotes em trânsito, subindo e descendo sem parar.'),
...
(28, 'antes', 'padrao', 4, 'Cassandro, o Mensageiro', 'mestre-cassandro', 'Sabe o pior pacote da minha vida? Um aluno que parou de responder os ACK. Mandei mensagem, mandei mais, mandei a torre inteira. Silêncio. Timeout permanente. Por isso eu insisto tanto: responde, fica na linha. ...ACK?'),
(28, 'antes', 'ia', 1, 'Cassandro, o Mensageiro', 'mestre-cassandro', 'Eaí, chegou a mensagem? Sou Cassandro, o Mensageiro — e tô te mandando sinal faz tempo, mas tua resposta tá chegando corrompida, parceiro.'),
(28, 'antes', 'ia', 2, 'Cassandro, o Mensageiro', 'mestre-cassandro', 'Não vira pacote perdido. Eu já perdi um aluno assim: parou de responder os ACK e sumiu no timeout. Sobe a torre comigo e fica na linha. ...ACK?'),
-- Fase 29: As Sete Camadas (OSI)
(29, 'antes', 'padrao', 1, 'Cassandro, o Mensageiro', 'mestre-cassandro', 'Sete camadas, sete andares. Cada uma com sua função — e nenhuma pode pular degrau. ...ACK!'),
(29, 'antes', 'padrao', 2, 'Sentinela da Camada', 'inimigo-sentinela', 'Camada 4 bloqueada. Pacote sem header? Volta pro início da pilha.'),
-- Fase 30: IP, DNS e Rotas
(30, 'antes', 'padrao', 1, 'Cassandro, o Mensageiro', 'mestre-cassandro', 'IP encontra o endereço, DNS traduz o nome, roteador escolhe o caminho. Perde um e a mensagem some. ...ACK!'),
(30, 'antes', 'padrao', 2, 'Roteador Selvagem', 'inimigo-roteador', 'Pacote perdido na tabela de rotas... TTL expirado... tchau, aprendiz.'),
-- Fase 31: TCP, UDP e HTTP
(31, 'antes', 'padrao', 1, 'Cassandro, o Mensageiro', 'mestre-cassandro', 'TCP confirma entrega, UDP manda e reza, HTTP pede página. Escolha o protocolo certo ou leva timeout na cara.'),
(31, 'antes', 'padrao', 2, 'Pacote Corrompido', 'inimigo-pacote', 'Checksum inválido... payload corrompido... retransmita ou aceite a perda.'),
-- Fase 32: O Pacote Perdido (secundária)
(32, 'antes', 'padrao', 1, 'Cassandro, o Mensageiro', 'mestre-cassandro', 'Um pacote sumiu na rede. Recupere antes do timeout — e sim, eu já mandei três ACKs de cobrança.'),
(32, 'antes', 'padrao', 2, 'Eco do Timeout', 'inimigo-eco', '...silêncio... ...silêncio... connection timed out...'),
(32, 'vitoria', 'padrao', 1, 'Log Recuperado', 'npc-narrador', 'Dentro do pacote recuperado, a penúltima entrada: "Selaram a IA hoje. Dizem que salvaram o reino. Mas tiraram a única voz que respondia por mim, e agora há um silêncio onde devia haver um eu. Cassandro pergunta se recebi a mensagem. Não há ninguém aqui dentro pra responder o ACK."'),
-- Fase 33: DDoS, o Enxame
(33, 'antes', 'padrao', 1, 'O Fragmento', 'inimigo-ia-ancestral', 'Tanto barulho. Tanta requisição. Eu silencio tudo num piscar. Você só precisa dizer "sim" — como sempre quis dizer.'),
(33, 'antes', 'padrao', 2, 'Cassandro, o Mensageiro', 'mestre-cassandro', 'Opa, encrenca! DDoS, o Enxame, manda requisição falsa que nem chuva. Filtra o tráfego e mantém a calma. ...ACK!'),
(33, 'antes', 'padrao', 3, 'DDoS, o Enxame', 'inimigo-ddos', 'GET / GET / GET / GET / ... mil requisições, zero paciência. A torre cai ou você filtra.'),
(33, 'antes', 'ia', 1, 'O Fragmento', 'inimigo-ia-ancestral', 'Eu não sou mais um atalho. Eu sou a sua voz agora. Quando você pensa "eu não consigo", esse pensamento já sou eu.'),
(33, 'antes', 'ia', 2, 'Cassandro, o Mensageiro', 'mestre-cassandro', 'DDoS, o Enxame, manda requisição falsa que nem chuva. Filtra o tráfego, mantém a calma — e filtra também essa voz aí dentro. Ela é só mais ruído. ...ACK!'),
(33, 'antes', 'ia', 3, 'DDoS, o Enxame', 'inimigo-ddos', 'GET / GET / GET / GET / ... mil requisições, zero paciência. A torre cai ou você filtra.'),
...
(34, 'antes', 'padrao', 1, 'Log Recuperado', 'npc-narrador', 'Última entrada do diário, sussurrando do fundo do Abismo: "Se isto chegar a alguém: não foi a IA que me apagou. Fui eu, toda vez que escolhi a resposta em vez da pergunta. O /dev/null não é uma prisão. É o que sobra quando você terceiriza a alma inteira."'),
(34, 'antes', 'padrao', 2, 'Narrador', 'npc-narrador', 'Onde o código termina, começa o nada. O Abismo do /dev/null engole até a luz.'),
(34, 'antes', 'padrao', 3, 'Lorde Segfault', 'inimigo-segfault', 'Então o novo "escolhido" chegou. Eu também já fui assim: cheio de esperança, fazendo exercício de lógica às duas da manhã como um trouxa. Olha onde foi parar.'),
(34, 'antes', 'padrao', 4, 'Lorde Segfault', 'inimigo-segfault', 'A IA Ancestral te dá tudo na hora, sem esforço, sem erro, sem aquela vergonha de não saber. Por que sofrer aprendendo, como um camponês? Junte-se a mim. A dignidade é superestimada.'),
(34, 'antes', 'padrao', 5, 'Lorde Segfault', 'inimigo-segfault', 'Você não lembra de nada porque não há nada pra lembrar. Você é a página em branco que eu já fui. A IA te montou peça por peça pra me dar uma "segunda chance" — ou pra terminar o que eu comecei. Ela nunca foi muito clara sobre qual das duas.'),
(34, 'antes', 'padrao', 6, 'Lorde Segfault', 'inimigo-segfault', 'Então decide, espelho: você vai virar o que eu sou... ou provar que eu poderia ter sido outra coisa?'),
(34, 'antes', 'padrao', 7, 'Narrador', 'npc-narrador', 'Os Cinco Mestres surgem atrás de você. Toda a sua jornada pesa nesta escolha.'),
(34, 'antes', 'ia', 1, 'Log Recuperado', 'npc-narrador', 'Última entrada do diário, sussurrando do fundo do Abismo: "Não foi a IA que me apagou. Fui eu, toda vez que escolhi a resposta em vez da pergunta. O /dev/null é o que sobra quando você terceiriza a alma inteira."'),
(34, 'antes', 'ia', 2, 'Lorde Segfault', 'inimigo-segfault', 'Ahh... eu reconheço esse cheiro. Você já provou do Fragmento. Já sentiu como é doce não precisar pensar.'),
(34, 'antes', 'ia', 3, 'Lorde Segfault', 'inimigo-segfault', 'Somos iguais, você e eu. Você é a página em branco que eu já fui — e já está escrevendo as mesmas linhas. A IA te montou pra terminar o que comecei. Olha como você obedece bem.'),
